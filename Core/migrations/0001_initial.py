    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pt_tax', models.PositiveIntegerField(blank=True, default=1, null=True)),
                ('pt_offer', models.PositiveIntegerField(blank=True, default=1, null=True)),
                ('pt_timestamp', models.DateTimeField(auto_now_add=True)),
                ('pt_item', models.OneToOneField(on_delete=django.db.models.deletion.DO_NOTHING, to='Core.itemtable')),
            ],
        ),
    ]
